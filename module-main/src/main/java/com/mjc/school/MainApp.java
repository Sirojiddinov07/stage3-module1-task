...
import com.mjc.school.repository.impl.NewsController;
...
import static com.mjc.school.repository.servise.exeptions.ExceptionConstants.INT_VALUE_OUT_OF_RANGE;
        ...
        try {
            switch (operationNumber) {
                ...
                case 3 -> {
                    ...
                    if (scanner.hasNextInt()) {
                        id = scanner.nextInt();
                        System.out.println(controller.create(new NewsDtoReq(1L, title, content, id)));
                    } else {
                        throw new ValidatorException(String.format(INT_VALUE_OUT_OF_RANGE.getCodeMsg()));
                    }
                ...
                case 4 -> {
                    ...
                    if (scanner.hasNextInt()) {
                        ...
                        System.out.println(controller.update(new NewsDtoReq(id, title, content, authId)));
                    } else {
                        throw new ValidatorException(String.format(INT_VALUE_OUT_OF_RANGE.getCodeMsg()));
                    }
